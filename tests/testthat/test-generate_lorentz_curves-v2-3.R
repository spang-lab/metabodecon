...
test_that("3. generate_lorentz_curves_v2 with: 2 jcampdx, answers == nyyn**y*n*y", {
    ...
    ## Call function #####
    x <- with(
        testdir = "generate_lorentz_curves_v2/3",
        output = "captured",
        message = "captured",
        plots = "plots.pdf",
        ...
        expr = {
            set.seed(123)
            generate_lorentz_curves_v2(data_path = "urine", file_format = "jcampdx")
        }
    )
