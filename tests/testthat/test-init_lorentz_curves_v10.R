...
test_that("init_lorentz_curves_v10 works", {
    x <- MetaboDecon1D_urine1_1010yy_ni1_dbg(cache = TRUE)$rv
    ...
    y <- init_lorentz_curves_v10(spectrum_x, spectrum_y, filtered_peaks, filtered_left_position, filtered_right_position, save_scores) # see warning above why we calculate y twice
