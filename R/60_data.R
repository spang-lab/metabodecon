...
#' > session's temporary directory \[...\] Limited exceptions may be allowed in
#' > interactive sessions if the package obtains confirmation from the user. For
#' > R version 4.0 or later \[...\] packages may store user-specific data,
