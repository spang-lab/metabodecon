...
#> Warning: /tmp/Rtmp4k99dS/metabodecon/data/example_datasets/bruker/urine does not exist. Please call `download_example_datasets(extract = TRUE)` first.
y <- datadir("example_datasets/bruker/urine")  # Preferred
#> Warning: /tmp/Rtmp4k99dS/metabodecon/data/example_datasets/bruker/urine does not exist. Please call `download_example_datasets()` first.
cat(x, y, sep = "\n")
#> /tmp/Rtmp4k99dS/metabodecon/data/example_datasets/bruker/urine
#> /tmp/Rtmp4k99dS/metabodecon/data/example_datasets/bruker/urine
```
