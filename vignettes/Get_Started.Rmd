...
<style>
figure{border: 1px solid #dee2e6; border-radius: .375rem; padding: 0;}
figcaption{text-align: center; font-style: italic;
           border-top: 1px solid #dee2e6; padding: 0.75rem;
           background-color: #ffffff;}
.sourceCode.txt{background-color: #f1f3f5;}
</style>
...
[^wshw]: Since the used dataset was simulated based on actual measurement in the
    range of approx. 3.6  to  3.3  ppm,  it  doesn't  contain  a  water
