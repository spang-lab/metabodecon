...
To generate a matrix of features based on the spectrum data, you can use `gen_feat_mat()`. The resulting matrix will have one row for each spectrum and one column for each chemical shift.

```R
feat <- gen_feat_mat(deconvs)
str(feat, 2)
## List of 5
##  $ data_matrix: num [1:16, 1:1309] 0.01351 0.02418 0.00798 0.00881 0.00514 ...
##   ..- attr(*, "dimnames")=List of 2
##  $ peakList   :List of 16
##   ..$ sim_01: num [1:13] 351 417 458 584 684 ...
##   ..$ sim_02: num [1:11] 371 413 478 519 644 ...
##   ...
##   ..$ sim_16: num [1:13] 0.959 0.893 0.852 0.727 0.628 ...
##  $ w          :List of 16
##   ...
##  $ A          :List of 16
##   ...
