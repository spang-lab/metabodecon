...
plot_rep_grid(train_speaq$raw_specs, train_speaq$decon_mse, idx,
  title_prefix = "Speaq pipeline before deconvolution")
plot_rep_grid(train_speaq$decon_specs, train_speaq$decon_mse, idx,
  title_prefix = "Speaq pipeline after deconvolution")
