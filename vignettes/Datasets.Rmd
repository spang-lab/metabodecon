...
The 16 simulated spectra are plotted in [Figure 1: Simulated Datasets](). For further details about the simulation process, see the source code of function `simulate_spectra()`.
